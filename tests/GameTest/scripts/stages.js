...
function setLevel1()
{
    ...
    bg = new Entity("bg", true, canvasWidth/2, canvasHeight/2, false);
    bg.AddShapedChild("spr", new Sprite(game, canvasWidth, canvasHeight, game.assetManager.getAssetPath("bg.png")));
